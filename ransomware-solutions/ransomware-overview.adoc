...
NOTE: NetApp ONTAP répond aux exigences en matière d'authentification Web https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["Authentification multifacteur (MFA)"^] dans System Manager et d'authentification SSH CLI.
...
* link:ransomware-DII-workload-security.html["Data Infrastructure Insights Stockage Charge de travail Sécurité"]
