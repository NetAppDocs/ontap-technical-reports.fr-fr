...
====
Pour en savoir plus sur la sécurisation des LIF, consultez link:https://docs.netapp.com/us-en/ontap/networking/configure_firewall_policies_for_lifs.html["Configuration des politiques de pare-feu pour les LIF"^]. Cette page fournit également des détails sur les politiques de service LIF à partir d' ONTAP 9.10.1.

Pour en savoir plus sur la création d'une nouvelle politique de service, consultez la documentation. `network interface service-policy create` commande dans le link:https://docs.netapp.com/us-en/ontap-cli/network-interface-service-policy-create.html["Référence des commandes."^]
