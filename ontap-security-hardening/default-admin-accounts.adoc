...
NOTE: Vous ne pouvez pas supprimer ni renommer les comptes intégrés. Si un administrateur supprime le compte, au redémarrage, le compte intégré sera recréé. *NetApp recommande* de verrouiller tout compte intégré inutile avec la commande lock.
