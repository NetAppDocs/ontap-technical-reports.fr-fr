...
NOTE: L'API REST /api/storage/volumes est utilisée pour plus que l'accès aux fichiers. Elle est utilisée par System Manager et d'autres interfaces graphiques pour créer, visualiser et modifier des volumes.
