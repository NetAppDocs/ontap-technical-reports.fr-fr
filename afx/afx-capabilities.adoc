...
Pour plus d'informations sur la façon dont les volumes FlexGroup bénéficient de l'architecture AFX, voir link:afx-architecture.html#flexgroup-volume-management-improvements["Améliorations de la gestion des volumes FlexGroup"].
