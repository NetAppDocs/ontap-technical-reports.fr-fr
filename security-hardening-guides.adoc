...
link:https://www.netapp.com/pdf.html?item=/media/83591-tr-4963.pdf["TR-4963 : Guide de renforcement de la sécurité : NetApp Backup and Recovery pour les applications"^]Découvrez comment configurer NetApp Cloud Backup for Applications pour aider les organisations à atteindre les objectifs de sécurité prescrits en matière de confidentialité, d’intégrité et de disponibilité des systèmes d’information.
