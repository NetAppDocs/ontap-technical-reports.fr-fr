...
link:https://www.netapp.com/pdf.html?item=/media/13481-tr4689.pdf["Tr-4689 : IP NetApp MetroCluster"^] MetroCluster est une solution de stockage à disponibilité continue pour ONTAP fonctionnant sur les systèmes FAS et AFF. MetroCluster IP représente la dernière évolution et utilise une infrastructure de stockage dorsale basée sur Ethernet. MetroCluster IP offre une configuration hautement redondante pour répondre aux besoins des applications métier les plus critiques. MetroCluster IP est inclus dans ONTAP et assure la connectivité NAS et SAN pour les clients et serveurs utilisant le stockage ONTAP.
