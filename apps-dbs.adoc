...
Découvrez les performances de Microsoft SQL Server sur les systèmes NetApp AFF de la gamme ASeries et AFF C-Series, et comment choisir le système adapté à vos besoins de stockage en fonction de l'utilisation des charges de travail.
